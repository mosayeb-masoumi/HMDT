...
class BarcodeData {
    ...
    constructor(id: String?, mygroup: String?, decription: String?, subCategory: String?,
                main: String?, category: String?, owner: String?, brand: String?,
                subBrand: String?, company: String?, country: String?, unit: String?,
