...
import com.example.panelist.models.shopping_edit.Data;
...
public class NewRegisterActivity2 extends CustomBaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectivityReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                tools.doCheckNetwork(NewRegisterActivity2.this, findViewById(R.id.drawer_layout_home));
            }
        };
        ...
        dialogFactory = new DialogFactory(NewRegisterActivity2.this);
...
//
//            recycler_prize.setLayoutManager(new GridLayoutManager(NewRegisterActivity2.this, 3));
//            adapterEditPrize = new AdapterEditPrize(sendPrizes, NewRegisterActivity2.this);
//            recycler_prize.setAdapter(adapterEditPrize);
    ...
    private void setSpinner() {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(NewRegisterActivity2.this, R.layout.custom_spinner, shopList);
...
//                }
    ...
    private void showAddMemberDialog() {
        ...
        editMembers = new ArrayList<>();
        final Dialog dialog = new Dialog(NewRegisterActivity2.this);
        ...
        recyclerview_members.setLayoutManager(new LinearLayoutManager(NewRegisterActivity2.this));
        adapter_member = new AdapterRegisterMemberDialog(members, NewRegisterActivity2.this);
    ...
    private void showPrizeDialog() {
        ...
        Button btn_exit_dialog = dialog.findViewById(R.id.btn_exit_dialog);
        ImageView img_close = dialog.findViewById(R.id.img_close);
        recycler_prize.setLayoutManager(new LinearLayoutManager(NewRegisterActivity2.this));
        adapter_prize = new AdapterPrize(prizes, NewRegisterActivity2.this);
...
//            editMembers.add(new RegisterMemberEditModel(name, "Ali"));
...
//            updateEditMemberList(editMembers);
    ...
    public void updateEditMemberList(ArrayList<RegisterMemberEditModel> editMembers) {
        ...
        recyclerEditedMember.setLayoutManager(new GridLayoutManager(NewRegisterActivity2.this, 3));
        adapter_edited = new AdapterRegisterMemberEdit(editMembers, NewRegisterActivity2.this);
...
//        }
    ...
    private void sendRegisterData() {
        ...
        call.enqueue(new Callback<GetShopId>() {
            ...
            public void onResponse(Call<GetShopId> call, Response<GetShopId> response) {
                if (response.code() == 200) {
                    ...
                    if (builderMember != null) {
                        Toast.makeText(NewRegisterActivity2.this, "" + builderMember, Toast.LENGTH_SHORT).show();
                    }
                    if (builderShopId != null) {
                        Toast.makeText(NewRegisterActivity2.this, "" + builderShopId, Toast.LENGTH_SHORT).show();
                    }
                    if (builderCost != null) {
                        Toast.makeText(NewRegisterActivity2.this, "" + builderCost, Toast.LENGTH_SHORT).show();
                    }
                    if (builderPaid != null) {
                        Toast.makeText(NewRegisterActivity2.this, "" + builderPaid, Toast.LENGTH_SHORT).show();
                    }
                    if (builderDiscountAmount != null) {
                        Toast.makeText(NewRegisterActivity2.this, "" + builderDiscountAmount, Toast.LENGTH_SHORT).show();
                    }
                   if (builderDate != null) {
                        Toast.makeText(NewRegisterActivity2.this, "" + builderDate, Toast.LENGTH_SHORT).show();
                    }
                    if (buliderPrize != null) {
                        Toast.makeText(NewRegisterActivity2.this, "" + buliderPrize, Toast.LENGTH_SHORT).show();
                    }
                    ...
                    Toast.makeText(NewRegisterActivity2.this, "" + getResources().getString(R.string.serverFaield), Toast.LENGTH_SHORT).show();
                    btn_register.setVisibility(View.VISIBLE);
                    avi.setVisibility(View.GONE);
                }
            }
            ...
            public void onFailure(Call<GetShopId> call, Throwable t) {
                Toast.makeText(NewRegisterActivity2.this, "" + getResources().getString(R.string.connectionFaield), Toast.LENGTH_SHORT).show();
                btn_register.setVisibility(View.VISIBLE);
                avi.setVisibility(View.GONE);
            }
        });
    ...
    private void sendUpdateData() {
        ...
        String id= Cache.getString("shopping_id");

        sendData.setId(Cache.getString("shopping_id"));
...
//                sendPrizes.add(new SendPrize(desc, "Ali"));
